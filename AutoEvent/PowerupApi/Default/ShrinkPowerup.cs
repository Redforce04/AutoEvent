...
//    Solution:         AutoEvent
//    Project:          PowerupApi
//    FileName:         ResizeSmallPowerup.cs
...
{
    public ShrinkPowerup(float scaleMultiplier, float powerupDuration)
    {
        ResizeAmount = new Vector3(scaleMultiplier,scaleMultiplier,scaleMultiplier);
        PowerupDuration = powerupDuration;
    }
    public ShrinkPowerup(Vector3 scaleMultiplier, float powerupDuration)
    {
        ResizeAmount = scaleMultiplier;
        PowerupDuration = powerupDuration;
    }
    public override string Name { get; protected set; } = "Shrink";
    public override string Description { get; protected set; } = "Shrinks you down.";
    protected override string SchematicName { get; set; } = "ResizeSmall";
